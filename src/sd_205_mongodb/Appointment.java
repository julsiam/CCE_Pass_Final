...
public class Appointment extends javax.swing.JFrame {
    ...
    public void MongoConnect() {
        ...
        MongoDatabase appointmentCollection = mongo.getDatabase("CCE_Pass");
        appointmentCollection.createCollection("appointment");
    }
    ...
    private void initComponents() {
        ...
        phone.setFont(new java.awt.Font("Segoe UI Symbol", 0, 14)); // NOI18N
        phone.setBorder(null);
        jPanel2.add(phone, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 190, 250, 30));
        ...
        address.setFont(new java.awt.Font("Segoe UI Symbol", 0, 14)); // NOI18N
        address.setBorder(null);
        jPanel2.add(address, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 190, 250, 30));
        ...
        time.setFont(new java.awt.Font("Segoe UI Symbol", 0, 14)); // NOI18N
        time.setBorder(null);
        jPanel3.add(time, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 120, 320, 30));
        ...
        jLabel15.setText("Appointment Date (mm/dd/yy)");
        ...
        date.setFont(new java.awt.Font("Segoe UI Symbol", 0, 14)); // NOI18N
        date.setBorder(null);
        jPanel3.add(date, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 120, 320, 30));

        subject.setFont(new java.awt.Font("Segoe UI Symbol", 0, 14)); // NOI18N
        subject.setBorder(null);
        jPanel3.add(subject, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 120, 320, 30));
    ...
    private void backBtn1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_backBtn1MouseClicked
        if (this.fname.getText().isEmpty() || this.lname.getText().isEmpty() || this.email.getText().isEmpty() || this.phone.getText().isEmpty() || this.address.getText().isEmpty()
                || this.subject.getText().isEmpty() || this.date.getText().isEmpty() || this.time.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Fill out all the fields!", "Alert", JOptionPane.ERROR_MESSAGE);

        } else {
            MongoClient mongo = new MongoClient("localhost", 27017);
            MongoDatabase appointmentCollection = mongo.getDatabase("CCE_Pass");
            appointmentCollection.getCollection("appointment"); //to get the collection from db
            ...
            d.append("phone", this.phone.getText());
            d.append("address", this.address.getText());
            d.append("subject", this.subject.getText());
            d.append("date", this.date.getText());
            d.append("time", this.time.getText());
            d.append("status", "Pending");

            appointmentCollection.getCollection("appointment").insertOne(d);
